    ...
    internal sealed class Configuration : DbMigrationsConfiguration<B2WTI.PCFTI.INFRAESTRUTURA.HORIZONTAL.PCFTIDataContext>
    {
        ...
        protected override void Seed(B2WTI.PCFTI.INFRAESTRUTURA.HORIZONTAL.PCFTIDataContext context)
        {
            ...
            List<Regra> regras = new List<Regra>()
            {
                ...
                new Regra() { RegraId = Guid.Parse("019e6d49-2482-42e7-8a13-a6d438f1d3c5"), Nome = "ADMINISTRADOR", CriadoPor = @"LAB2W\fabio.braga", CriadoEm = DateTime.Now },
                new Regra() { RegraId = Guid.Parse("bbbd9ee6-0a4e-48c5-b316-c88527ac3601"), Nome = "COLABORADOR", CriadoPor = @"LAB2W\fabio.braga", CriadoEm = DateTime.Now },
                new Regra() { RegraId = Guid.Parse("c678af8e-adb1-4ee5-8bed-109d2dd06021"), Nome = "SUPER-BENIFICIARIO", CriadoPor = @"LAB2W\fabio.braga", CriadoEm = DateTime.Now },
                new Regra() { RegraId = Guid.Parse("faf49f33-daf6-461e-bb72-977375a34eab"), Nome = "BENIFICIARIO", CriadoPor = @"LAB2W\fabio.braga", CriadoEm = DateTime.Now }
            };

            context.Regra.AddRange(regras);
            context.SaveChanges();
